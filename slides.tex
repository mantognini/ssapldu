...
\begin{frame}[fragile]{$DSG$ transformers: 2}
  \[
  \mtransformerDSG{x.sel := nil} \left( \langle E_v, E_s \rangle \right)
  \defeq \langle E_v, E_s - \left\{ \langle \mbox{s}, \mbox{sel}, * \rangle \mid \left[x,s\right] \in E_v \right\} \rangle
  \]
