...
\begin{frame}{Abstract interpretation, abstractly}
  ...
  \begin{center}
    \begin{tikzpicture}[semithick,
      ...
      level 4/.style={onslide=<-4>{transparent}},
      level 5/.style={onslide=<-5>{transparent}},
      level 6/.style={onslide=<-6>{transparent}},
      ampersand replacement=\&, >=cm to]
      \Large
      ...
      \uncover<6->{\draw[->] (S1) -- node[right]{$\mtransformerSSG{s}$} (S2);}
...
\begin{frame}[fragile]{Abstract interpretation -- examples}
